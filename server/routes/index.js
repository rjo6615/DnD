...
const characterCurrency = require('./characters/currency');
const characterTemporary = require('./characters/temporary');
...
characterCurrency(routes);
characterTemporary(routes);
skills(routes);
feats(routes);
equipment(routes);
